...
PRFText1 = uicontrol('parent',mf1,...
    ...
    'FontSize', 10,...
    'String', 'PRF for Stage One (1.09~1.11 MHz)',...
    'Visible','off');
...
PRF1 = uicontrol('parent',mf1,...
    ...
    'Visible','off',...
    'Value',10000,...
    'Min',100,'Max',1.1e6,'SliderStep',[0.05,0.15],...
    'Callback',@PRFSelect1);

    function PRFSelect1(varargin)
        Max_PD1 = 1/PRF1.Value * 1e6;
        set(PD1,'Max', Max_PD1);
...
PDText1 = uicontrol('parent',mf1,...
    ...
    'FontSize', 10,...
    'String', 'PD for Stage One (10 us-200 us)',...
    'Visible','off');
...
PD1 = uicontrol('parent',mf1,...
    ...
    'Visible','off',...
    'Value',20,...
    'Min',1,'Max',200,'SliderStep',[0.01,0.1],...
    'Callback',@PDSelect1);
...
BurstNum1 = uicontrol('parent',mf1,...
    ...
    'Value',1,...
    'Min',1,'Max',2,'SliderStep',[0.1,0.2],...
