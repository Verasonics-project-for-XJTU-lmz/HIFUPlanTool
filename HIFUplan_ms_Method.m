...
Stage = uicontrol('parent',mf1,...
    ...
    function StageSelect(varargin)
        ...
        if Stage.Value == 1
            ...
            set(BurstNumText2,'Visible','on','String','Burst Number before Off-Time (1-35)');
            set(BurstNum2,'Visible','on','Min',1,'Max',35,'Value',8);
            set(BurstNumSet2,'Visible','on');
            set(BurstNumSet2,'String','8');
...
StageSet = uicontrol('parent',mf1,...
    ...
    function StageShow(varargin)
        ...
        if strcmp(StageSet.String, '1')
            ...
            set(PD2,'Visible','on');
            set(PDSet2,'Visible','on');
            set(BurstNumText2,'Visible','on','String','Burst Num before Off-Time (1-35)');
            set(BurstNum2,'Visible','on','Min',1,'Max',35,'Value',8);
            set(BurstNumSet2,'String','8');
            set(BurstNumSet2,'Visible','on');
...
PRFText2 = uicontrol('parent',mf1,...
    ...
    'FontSize', 10,...
    'String', 'PRF for Stage Two (1~200 Hz)',...
    'Visible','off');
